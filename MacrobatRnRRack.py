...
class MacrobatRnRRack(ControlSurfaceComponent):
	...
	if self._on_off_param and self._on_off_param[0]:
		...
		self._parent.schedule_message(1, self.do_device_randomize, 'all')
	    elif self._on_off_param[1].startswith('NK RND'):
		self._parent.schedule_message(1, self.do_device_randomize, 'next') 
	    elif self._on_off_param[1].startswith('NK RST ALL'):
		self._parent.schedule_message(1, self.do_device_reset, 'all')
	    elif self._on_off_param[1].startswith('NK RST'):
		self._parent.schedule_message(1, self.do_device_reset, 'next') 
